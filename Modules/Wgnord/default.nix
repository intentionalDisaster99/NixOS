    ...
    (
      ...
      let
        ...
        nordVPNBase = stdenv.mkDerivation {
          ...
          src = fetchurl {
            url = "https://repo.nordvpn.com/deb/nordvpn/debian/pool/main/nordvpn_${version}_i386.deb";
  ...
  security.sudo.extraRules = [
    {
      ...
      commands = [
        {
          command = "/run/current-system/sw/bin/systemctl start wgnord";
          options = [ "NOPASSWD" ];
        }
        {
          command = "/run/current-system/sw/bin/systemctl stop wgnord";
          options = [ "NOPASSWD" ];
        }
      ];
    }
